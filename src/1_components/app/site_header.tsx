...
import {
	...
	BreadcrumbPage,
	BreadcrumbSeparator,
} from "#src/1_components/ui/breadcrumb";
import { Separator } from "#src/1_components/ui/separator";
import { SidebarTrigger } from "#src/1_components/ui/sidebar";
...
export function SiteHeader() {
	...
	const breadcrumbs = matches
		...
		.map(({ pathname, context }) => ({ path: pathname, title: context.title }));
