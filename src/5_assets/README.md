...
1. Create a folder: `src/5_assets/your-asset/`
...
4. Register in `vite.config.ts`:
   ...
   ```ts
   import { main as prepareYourAssetData } from "./src/5_assets/your-asset/generate-data.ts";
...
```bash
bun run ./src/5_assets/legacy-json/compare-with-active-pipelines.ts
```
